public class Fecha {
    ...
    public void setFechaMatriculacion(Fecha fecha) {
        fechaMatriculacion.setDia(fecha.getDia());
        fechaMatriculacion.setMes(fecha.getMes());
        fechaMatriculacion.setAño(fecha.getAño());
    }
