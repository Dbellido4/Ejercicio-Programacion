...
public class Gestisimal {
  ...
  public static void main(String[] args) {
	...
	Scanner precioCompra=new Scanner (System.in);
      ...
      switch (opcion) {
        ...
        case 2:
          ...
          if (primeraLibre == N) {
            ...
            precioDeCompraIntroducido = Double.parseDouble(precioCompra.next());
            articulo[primeraLibre].setPrecioDeCompra(precioDeCompraIntroducido);
            
            System.out.print("Precio de venta: ");
            precioDeVentaIntroducido = Double.parseDouble(precioVenta.next());
            articulo[primeraLibre].setPrecioDeVenta(precioDeVentaIntroducido);
            
            System.out.print("Stock: ");
            stockIntroducido = Integer.parseInt(stock.next());
